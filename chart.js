function calculateRetirement() {
  ...
  for (let i = 0; i < months; i++) {
    ...
    totalInvested += i === 0 ? monthlyAmount : aporte;
    const interest =
  ...
  document.getElementById("result").innerHTML = `
      ...
      <p class="montserrat"><span class="icon material-icons">trending_up</span>Rendimento Mensal (1% ao mês): <strong>${monthlyReturn.toLocaleString(
        "pt-BR",
        {
          style: "currency",
          currency: "BRL",
